...
<div class="main-header">
    ...
    <p>Tác giả: Hà Thị Chi - Trường PTDTBT TH Khâu Vai - ĐT: 0982 495 505</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hà Thị Chi - Trường PTDTBT TH Khâu Vai - ĐT: 0982 495 505</div>", unsafe_allow_html=True)
